...
public class Pro1_SimModelFactory extends SimModelFactory {

	private static final Logger sLogger = LogManager.getLogger(Pro1_SimModelFactory.class);

	private final Pro1_ModelFactory_Behaviors fBehaviors;

	@Inject
	public Pro1_SimModelFactory(EventBus eventBus, InputValues inputValues, OutputValues outputValues, Dashboard dashboard, RobotConfiguration robotConfiguration, ObjectsDirectory objectsDirectory) {
